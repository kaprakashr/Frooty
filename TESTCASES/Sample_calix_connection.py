...
from src.libs.calix.calix import *

def TEST_CASE_001():
    log.rite("Starting Test Case 001\n")
    connect_to_generic_device = calix_telnet_connection(devices['DEVICE_1'])
...
def TEST_CASE_003():
    ...
    connect_to_generic_device = calix_ssh_connection(devices['DEVICE_1'])
    print connect_to_generic_device.show_command('show version')
    log.rite(str(connect_to_generic_device.show_command('show version')))
    return 1
